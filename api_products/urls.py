...
router.register(r'import/csv/products',
                views.CreateProductsCsvViewSet, basename='product-add')
router.register(r'import/csv/purchase_transactions',
                views.ProcessPurchaseCsvViewSet, basename='csv processing')
